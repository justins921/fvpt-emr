...
const envSchema = z.object({
  ...
  // Database
  DATABASE_URL: z.string().default('postgresql://emr:emr_dev_password@localhost:5432/fvpt_emr'),
  ...
  // Network security
  ALLOWED_ORIGINS: z.string().default('https://emr.local,http://localhost:5173'),
